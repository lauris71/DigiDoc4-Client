...
public:
    ...
    CKey(Tag tag) : type(Type::PUBLIC_KEY), unsupported(tag) {}
protected:
...
struct CKeyCDoc1 : public CKeyCert {
    ...
    static std::shared_ptr<CKeyCDoc1> newEmpty();
    static std::shared_ptr<CKeyCDoc1> fromCertificate(const QSslCertificate &cert);
};
